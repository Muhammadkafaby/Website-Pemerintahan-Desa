                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-gray-600 uppercase tracking-wider">Penulis</th>
                            ...
                            <tbody>
                                <tr v-for="post in posts.data" :key="post.id">
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ post.user.name }}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-right">
                                        ...
                                        <Link :href="route('admin.posts.destroy', post.id)" method="delete" as="button" class="text-red-600 hover:text-red-900 ml-4">Hapus</Link>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
